...
class WOWD_SERVER_DECL ChatHandler : public Singleton<ChatHandler>
{
public:
    ChatHandler();
    ~ChatHandler();
...
protected:
    ...
    bool HandleSpawnEntryCommand(const char* args, WorldSession *m_session);
    ...
    bool HandleSpawnCommand(const char *args, WorldSession *m_session);
    ...
    bool HandleBanReasonCharacterCommand(const char* args, WorldSession *m_session);
